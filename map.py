...
add_marker(m, [33.8547, 35.8623], 'Lebanon',
           ...
           <div style='height: 250px; overflow-y: scroll; font-size: 16px; line-height: 1.6; padding: 10px; width: 600px;'>
               ...
               <ul>
                   ...
                   <li>Tamer, A (2020). <em>On the Arab Identity and Its Discontents: A Personal Reflection and a Survey of Christian Perspectives.</em> SyriacPress.</li>
